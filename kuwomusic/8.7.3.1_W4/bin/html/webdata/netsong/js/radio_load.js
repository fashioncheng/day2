...
function SetRadioLikeState(radioid, bfav) {
    ...
    if (bfav) {
        ...
        DesObj.find(".playing_oper").find(".radio_liked").attr("title", "已喜欢")
    } else {
...
function CreateTimeSecRadio() {
    ...
    radiolist[radiolist.length] = '<ul class="playing_oper" ><li title="喜欢" class="radio_like"></li><li title="不喜欢" class="radio_dust" ></li><li title="更多" class="radio_add"></li></li></ul></a>';
